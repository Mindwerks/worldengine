...
from worldengine.common import count_neighbours, get_verbose
...
def draw_ancientmap(
    ...
    if draw_biome:
        ...
        def _draw_biome(name, _func, w, h, r, _alt_func=None):
                ...
                for x in range(resize_factor * world.width):
                    if biome_masks[name][y, x] > 0:
                        if r == 0 or border_neighbours[r][y, x] <= 2:
                            if _alt_func is not None and rng.random_sample() > 0.5:
            ...
            if verbose:
                ...
                print(
                    "...drawing_functions.draw_ancientmap: " + name + " Elapsed time " + str(elapsed_time) + " seconds."
                )
    ...
    if draw_biome:
        ...
        _draw_biome("cool temperate forest", _draw_temperate_forest1, 4, 5, 6, _draw_temperate_forest2)
